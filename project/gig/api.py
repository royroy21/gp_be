...
class GigViewSet(core_viewsets.CustomModelViewSet):
    ...
    def search(self, request):
        ...
        search = GigDocument.search().query(combined_query)
        ...
        if my_gigs:
            ...
            if request.query_params.get("past_gigs"):
                # If past gigs return without start_data filter.
                return self.return_parsed_search_response(
                    search,
                    exclude_requesting_user=True,
                )
